...
/**
 * Provides the local service interface for CourseSubscription. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Vitaliy Koshelenko
 * @see CourseSubscriptionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CourseSubscriptionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferaybook.courses.manager.service.impl.CourseSubscriptionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the course subscription local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CourseSubscriptionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CourseSubscription createCourseSubscription(
	...
	public CourseSubscription deleteCourseSubscription(
		CourseSubscription courseSubscription);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CourseSubscription fetchCourseSubscription(
		long courseSubscriptionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CourseSubscription getCourseSubscription(long courseSubscriptionId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CourseSubscription> getCourseSubscriptions(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CourseSubscription updateCourseSubscription(
		CourseSubscription courseSubscription);

...
public class CourseMVCCommandKeys {
    ...
    public static final String DELETE_LECTURE = "/courses/delete_lecture";
    public static final String EDIT_LECTURE = "/courses/edit_lecture";
    public static final String VIEW_LECTURE = "/courses/view_lecture";

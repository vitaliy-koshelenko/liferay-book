...
<liferay-ui:search-container total="<%= coursesService.getUserCoursesCount(scopeGroupId, userId) %>" iteratorURL="<%= iteratorURL %>"
                             delta="4" emptyResultsMessage="courses-empty-list">
    <liferay-ui:search-container-results results="<%= coursesService.getUserCourses(scopeGroupId, userId, searchContainer.getStart(), searchContainer.getEnd())  %>"/>

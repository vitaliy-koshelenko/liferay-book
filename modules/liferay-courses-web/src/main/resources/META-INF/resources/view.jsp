		...
		<clay:sheet-section>
			...
			<liferay-ui:search-container total="<%= coursesAPI.getCoursesCount() %>" delta="4" emptyResultsMessage="No Courses Found">
				...
				<liferay-ui:search-container-row className="com.liferaybook.courses.api.LiferayCourse" modelVar="course" keyProperty="courseId">
					<liferay-ui:search-container-column-text name="Course ID" value="${course.courseId}" />
					<liferay-ui:search-container-column-text name="Name" value="${course.name}" />
					<liferay-ui:search-container-column-text name="Description" value="${course.description}" />
					<liferay-ui:search-container-column-text>
						<liferay-ui:icon-menu direction="left-side" icon="" markupView="lexicon" message="actions" showWhenSingleIcon="<%= true %>">
							...
							<liferay-ui:icon-delete confirmation="Are you sure?" url="${deleteCourseURL}" />
